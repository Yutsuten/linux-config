...
nnoremap <silent> <C-t> :tabnew <Bar> tcd ~<CR>
...
nnoremap <silent> <F9>  :tabnew <Bar> call termopen(['.nvim/build_run'])<CR>
nnoremap <silent> <F33> :tabnew <Bar> call termopen(['.nvim/build'])<CR>
nnoremap <silent> <F34> :tabnew <Bar> call termopen(['.nvim/run'])<CR>
